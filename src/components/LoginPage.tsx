    ...
    <div className="relative min-h-screen flex items-center justify-center p-4 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="flex flex-col items-center mb-8 text-center">
          <div className="flex h-14 w-14 items-center justify-center rounded-xl ds-bg-gradient ds-shadow-button mb-4">
            <Briefcase className="h-7 w-7 text-white" />
          </div>
          <h1 className="text-3xl font-extrabold tracking-tight text-foreground">
            Apply<span className="ds-text-gradient">Track</span>
          </h1>
          <p className="text-foreground-muted text-sm mt-2 max-w-xs leading-relaxed">
            Трекер откликов на вакансии — профессионально и удобно
          </p>
        </div>

        <SpotlightCard className="p-8 space-y-6">
          <div className="text-center">
            <h2 className="text-lg font-bold text-foreground tracking-tight">Войдите в аккаунт</h2>
