    ...
    <div className="relative min-h-screen flex items-center justify-center p-4 overflow-hidden">
      ...
      <SpotlightCard interactive={false} className="relative z-10 w-full max-w-lg p-8">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h1 className="text-lg font-bold text-foreground">Ошибка загрузки приложения</h1>
        ...
        {isOutdatedDep && (
          <div className="mt-6 rounded-xl border border-slate-100 bg-slate-50 p-4">
            <p className="text-sm font-semibold text-foreground mb-2">Очистите кэш Vite:</p>
