  ...
  return (
    <div className="flex flex-wrap items-center gap-2 rounded-xl border border-blue-200 bg-blue-50 px-4 py-2.5">
      ...
      <Button
        ...
        className="h-8 gap-1.5 bg-white text-red-600 hover:bg-red-50 hover:text-red-700 hover:border-red-200"
      >
        <Trash2 className="h-3.5 w-3.5" />
        Удалить
      </Button>

      <Button variant="ghost" size="sm" onClick={onClear} className="h-8 gap-1.5 ml-auto text-blue-700">
